...
%       NS_ped_on : Boolean, if button for North/Souths
    ...
    if (EW_ped_on_before)
        ...
        EW_ped_red(false, ljHandle, lj_dig_bit, lj_dac_bit) % Implement
    end
    ...
    if (EW_ped_on_before)
        ...
        [NS_ped_on_2, EW_ped_on_2] = EW_ped_red(true, ljHandle, lj_dig_bit, lj_dac_bit, yellow_light_timing); % Implement
    else
